...
class StudentResourceIT {
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.grade(UPDATED_GRADE).contactNo(UPDATED_CONTACT_NO);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.fullName(UPDATED_FULL_NAME).address(UPDATED_ADDRESS).grade(UPDATED_GRADE).contactNo(UPDATED_CONTACT_NO);

...
// import { getEntity, deleteEntity } from './studentUser.reducer';
//
...
//       </ModalHeader>
//       <ModalBody id="noteToSchoolApp.student.delete.question">
//         <Translate contentKey="noteToSchoolApp.student.delete.question" interpolate={{ id: studentEntity.id }}>

...
//
// import { getEntity } from './studentUser.reducer';
//
...
//           <Translate contentKey="noteToSchoolApp.studentUser.detail.title">Student</Translate>
//         </h2>
...
//         </Button>
//         &nbsp;
//         <Button tag={Link} to={`/studentUser/${studentEntity.id}/edit`} replace color="primary">
...
// };
//
// export default StudentUserDetail;

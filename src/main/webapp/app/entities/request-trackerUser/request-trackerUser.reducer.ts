...
export const getEntities = createAsyncThunk('requestTrackerUser/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
  const requestUrl = `${apiUrl}?cacheBuster=${new Date().getTime()}`;
  return axios.get<IRequestTracker[]>(requestUrl);
});

export const getEntity = createAsyncThunk(
  'requestTrackerUser/fetch_entity',
...
export const createEntity = createAsyncThunk(
  'requestTrackerUser/create_entity',
...
export const updateEntity = createAsyncThunk(
  'requestTrackerUser/update_entity',
  async (entity: IRequestTracker, thunkAPI) => {
...
export const partialUpdateEntity = createAsyncThunk(
  'requestTrackerUser/partial_update_entity',
  async (entity: IRequestTracker, thunkAPI) => {
...
export const deleteEntity = createAsyncThunk(
  'requestTrackerUser/delete_entity',
...
export const RequestTrackerUserSlice = createEntitySlice({
  name: 'requestTrackerUser',
  initialState,
...
export const { reset } = RequestTrackerUserSlice.actions;

// Reducer
export default RequestTrackerUserSlice.reducer;

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTTRACKER_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTTRACKER actions', async () => {
      const expectedActions = [
        {

...
import { getEntities } from './request-tracker.reducer';
...
export const RequestTracker = () => {
  ...
  const requestTrackerList = useAppSelector(state => state.requestTracker.entities);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        {requestTrackerList && requestTrackerList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
            ...
            <tbody>
              {requestTrackerList.map((requestTracker, i) => (

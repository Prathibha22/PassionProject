...
export const BusDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="noteToSchoolApp.bus.delete.question">
        <Translate contentKey="noteToSchoolApp.bus.delete.question" interpolate={{ id: busEntity.id }}>

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bus.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUS actions', async () => {
      const expectedActions = [
        {
